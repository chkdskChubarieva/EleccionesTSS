...
def register_routes(app):
    ...
    app.add_url_rule("/analisis", view_func=AnalisisController.as_view("analisis"))
    ...
    app.add_url_rule("/api/sensitivity", view_func=ApiSensitivity.as_view("api_sensitivity"), methods=["GET", "POST"])